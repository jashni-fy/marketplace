...
RSpec.configure do |config|
  ...
  config.before do
    # Skip confirmation emails in tests by default
    # Using a more modern approach than allow_any_instance_of
    allow(User).to receive(:new).and_wrap_original do |m, *args|
      m.call(*args).tap do |user|
