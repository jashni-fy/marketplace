class Api::V1::PortfolioItemsController < ApiController
  ...
  # GET /api/v1/vendors/:vendor_profile_id/portfolio_items
  # GET /api/v1/portfolio_items (for current vendor)
  def index
  ...
  # PATCH/PUT /api/v1/portfolio_items/:id
  def update
  ...
  # DELETE /api/v1/portfolio_items/:id
  def destroy
    @portfolio_item.destroy
    render json: { message: 'Portfolio item deleted successfully' }
  end

  # POST /api/v1/portfolio_items/:id/upload_images
  def upload_images
    set_portfolio_item
    service = PortfolioManagementService.new(@portfolio_item.vendor_profile)
  ...
  # DELETE /api/v1/portfolio_items/:id/remove_image/:image_id
  def remove_image
    set_portfolio_item
  ...
  # GET /api/v1/portfolio_items/summary
  def summary
    ensure_vendor_role
    service = PortfolioManagementService.new(current_user.vendor_profile)
  ...
  # POST /api/v1/portfolio_items/reorder
  def reorder
    ensure_vendor_role
    service = PortfolioManagementService.new(current_user.vendor_profile)
  ...
  # POST /api/v1/portfolio_items/:id/duplicate
  def duplicate
    set_portfolio_item
    service = PortfolioManagementService.new(@portfolio_item.vendor_profile)
