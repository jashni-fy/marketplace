class Api::V1::ServiceImagesController < ApplicationController
  ...
  # GET /api/v1/services/:service_id/images/:id
  def show
    render json: {
  ...
  # PUT/PATCH /api/v1/services/:service_id/images/:id
  def update
  ...
  # DELETE /api/v1/services/:service_id/images/:id
  def destroy
  ...
  # POST /api/v1/services/:service_id/images/:id/set_primary
  def set_primary
  ...
  # POST /api/v1/services/:service_id/images/reorder
  def reorder
  ...
  # POST /api/v1/services/:service_id/images/bulk_upload
  def bulk_upload
